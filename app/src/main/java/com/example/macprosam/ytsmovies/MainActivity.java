...
String url = "https://yts.am/api/v2/list_movies.json";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        newmyAdapter = new MyAdapter(MainActivity.this, listm);
...
String tag3 =tag2.replace('"',' ');
    ...
    private void prepareAnnonce() {
        ...
        m.setDesc("hfhfhf");
        m.setTitle("gfgfgf");
        m.setOverview("fhgfgf");
        m.setNomimage("fhdjhfdf");
        //mmm= new ArrayList();

        mmm.add(m);

Toast.makeText(MainActivity.this, "mov"+mmm.toString(), Toast.LENGTH_SHORT).show();
